...
def crash_reports(
    ...
    try:
        ...
        if crashes_to_show:
            ...
            console.print(f"\n💡 Use [bold cyan]crashwise finding {run_id}[/bold cyan] for detailed analysis")
...
def monitor_callback(ctx: typer.Context):
    ...
    console.print("  • [cyan]cw monitor live <run-id>[/cyan] - Monitor with live updates (supports --once, --style)")
    console.print("  • [cyan]cw monitor crashes <run-id>[/cyan] - Show crash reports")
